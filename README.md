...
# Pie chart & Donut Chart
    A pie and donut charts is a circular chart divided into sectors which is proportional to the quantity it represents. These charts are very popular for showing a compact overview of a composition or comparison. While they can be harder to read than column charts, they remain a popular choice for small datasets.

# Installation
    CDN
        - <script src="https://code.highcharts.com/highcharts.js"></script>
        - https://github.com/highcharts/highcharts-dist
    Install from npm
...
# Properties
    inputdataset
        - Chart Dataset 
    charttype
        - Pie or Donut chart representation (Default as Pie)
    title
        - Provides the title to the chart
    subtitle
        - Provides the subtitle to the chart (Next to title)
    showlegend,
        - Shows the legends of chart from the provided dataset
    legendposition
        - Set the position of the legends (top,bottom). Defaults as bottom
    legendalingment
        - Sets alingment of the legens (left,center,right). Default as center
    height,
        - Set height of the chart
    width
        - Set width of the chart
    exporting
        - Enable the exporting option of the chart
